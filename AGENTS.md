...
- `scripts/utilities/` contains managed utility commands copied to `/usr/local/bin`, including `aliases`, `timecheck`, `updatecheck`, `internetcheck`, `lcsversion`, and `dockercheck`.
