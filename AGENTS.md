...
- Script logs belong in `/var/log/linux-cli-setup/`; create one log file per install, update, uninstall, or auto-update execution. Install, saved-profile refresh, and uninstall must print the exact persistent log path at the end of successful, failed, and interrupted runs.
